    ...
    *,
    ...
    return {
        ...
        "boundary_regions": region_report(
            ...
            classification="closure_reconstruction_required",
        ...
        "checks": {
            ...
            "self_intersection": {
                "status": "deferred_to_closed_candidate",
                "method": "libigl_cgal_exact_predicates",
            },
        },
        "not_checked": [],
    }
        ...
        items.append(
            {
                ...
                "failure_reason": (
                    ...
                    "unreported regions were not audited for exterior-policy decisions"
                ),
            }
        )
    return items
