...
def build_comparison_report(
    ...
    outputs = {
        ...
        "source_repair_candidate_vtp": (
            ...
            or two_stage.get("outputs", {}).get("hybrid_fused_candidate_vtp")
        ),
    ...
    patch_summary = two_stage.get("patch_region_summary", {})
    ...
    return {
        ...
        "comparisons": {
            **marker_report["comparison"],
            ...
            "patch_region_summary": patch_summary,
        },
        "gates": gates,
        "outputs": outputs,
        "unhandled_items": [
        ...
        "repair_report": {
            ...
            "change_summary": {
                ...
                "patch_transactions": patch_summary,
